...
<!-- SIDEBAR -->
    <aside id="sidebar"
      ...
      <nav class="flex flex-col space-y-6 text-gray-700 px-6">
        ...
        <a href="RapportServlet" class="flex items-center space-x-3 hover:text-blue-600 transition">
        ...
        <a href="PointageServlet?action=voir_absents" class="flex items-center space-x-3 hover:text-blue-600 transition">
        ...
        <a href="StatistiqueServlet" class="flex items-center space-x-3 hover:text-blue-600 transition">
