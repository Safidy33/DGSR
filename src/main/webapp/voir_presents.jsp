...
<%
    ...
    // Récupération des personnels présents
    List<Personnel> personnelsPresents = (List<Personnel>) request.getAttribute("personnelsPresents");
%>
<!DOCTYPE html>
<html lang="fr">
<head>
  ...
  <title>Personnel Présent - Système de Gestion de Pointage</title>
...
<body class="bg-white font-sans text-gray-800 min-h-screen flex flex-col">
  ...
  <div class="flex flex-1 min-h-0">
	...
	<jsp:include page="Menu_rapide.jsp">
        <jsp:param name="currentPage" value="voir_presents" />
    </jsp:include>
    ...
    <main class="flex-1 overflow-auto p-6">
      ...
      <!-- Tableau des personnels présents -->
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center justify-between mb-6">
            ...
            <span class="bg-green-100 text-green-800 text-sm font-medium px-3 py-1 rounded-full">
              <%= personnelsPresents != null ? personnelsPresents.size() : 0 %> personnes
            </span>
          </div>

          <% if (personnelsPresents != null && !personnelsPresents.isEmpty()) { %>
            <div class="overflow-x-auto">
              <table class="w-full text-sm text-left text-gray-900 border-collapse">
                ...
                <tbody>
                  <% for (Personnel personnel : personnelsPresents) { %>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                      <td class="px-6 py-4 font-medium flex items-center">
                        <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                          <span class="text-blue-600 font-semibold text-sm">
                            <%= personnel.getNom().charAt(0) %><%= personnel.getPrenom().charAt(0) %>
                          </span>
                        </div>
          ...
          <% } else { %>
            <div class="text-center py-12 text-gray-500">
              <p class="text-lg font-medium mb-2">Aucun personnel présent aujourd'hui</p>
              <p class="text-sm">Les employés n'ont pas encore pointé ou sont tous absents.</p>
            </div>
          <% } %>
        </div>
      </section>
